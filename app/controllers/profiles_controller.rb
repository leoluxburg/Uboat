class ProfilesController < ApplicationController
 ...
 #def destroy
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:nombre_completo, :fecha_de_nacimiento, :nacionalidad, :experiencia, :telefono, :nombre_emergencia, :telefono_emergencia, :user_id, :photo)
    end
end
